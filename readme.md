...
2. El label debe ser proporcionado desde fuera si no se quiere mostrar un label simplemente no enviar o ponerlo vacio
...
flags=”[{ key: ‘PER’, label: ‘+ 51’’}, {key: ‘BOL’, label: ‘+ 591’ }]”
default=”PER”
